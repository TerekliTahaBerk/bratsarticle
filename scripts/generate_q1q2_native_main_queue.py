#!/usr/bin/env python3
"""Generate the 225-job native main queue after loss freeze."""
...
from bratsarticle.experiments.q1q2_native_runner import main_convergence_specs
...
def main() -> None:
    ...
    specs = main_convergence_specs(runner_config, selected_loss)
    payload = {
        "schema_version": 1,
    ...
    output = Path("artifacts/q1q2_v2/queues/native_main.json")
