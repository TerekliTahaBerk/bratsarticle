#!/usr/bin/env python3
"""Generate the 25-job Swin main queue after development loss freeze."""
...
from bratsarticle.experiments.q1q2_swin_runner import swin_convergence_specs
from bratsarticle.utils.hashing import file_digest
from bratsarticle.utils.serialization import atomic_write_json


def main() -> None:
    runner_config = Path("configs/q1q2_v2/swin_m1_runner.yaml")
    selected_loss = Path("configs/q1q2_v2/selected_loss.yaml")
    specs = swin_convergence_specs(runner_config, selected_loss)
    payload = {
        "schema_version": 1,
    ...
    output = Path("artifacts/q1q2_v2/queues/swin_main.json")
