...
**[PENDING:METHOD.SELECTED_LOSS]**. Loss selection does not use the legacy
...
[PENDING:METHOD.EFFECTIVE_BATCH_SIZE_NATIVE_2D]. Validation occurs
every [PENDING:METHOD.VALIDATION_FREQUENCY_OPTIMIZER_STEPS] optimizer
...
[PENDING:METHOD.EARLY_STOPPING_MINIMUM_DELTA] with patience
[PENDING:METHOD.EARLY_STOPPING_PATIENCE_CHECKS] validation checks.
Compute-matched runs use
[PENDING:METHOD.COMPUTE_MATCHED_HOURS_PER_RUN] accelerator hours per run.
...
[PENDING:METHOD.CONFIDENCE_LEVEL] with
[PENDING:METHOD.PAIRED_BOOTSTRAP_RESAMPLES] paired resamples. The
sign-flip analysis uses
[PENDING:METHOD.PAIRED_PERMUTATION_RESAMPLES] resamples and family
alpha [PENDING:METHOD.MULTIPLICITY_ALPHA].
...
[PENDING:DESIGN.DEVELOPMENT_PATIENTS] patients,
[PENDING:DESIGN.FOLDS] folds,
[PENDING:DESIGN.SEEDS] common seeds,
[PENDING:DESIGN.MODELS] models, and
[PENDING:DESIGN.DEVELOPMENT_RUNS] development runs. The external
confirmatory and supportive cohorts contain
[PENDING:DESIGN.EXTERNAL_CONFIRMATORY_PATIENTS] and
[PENDING:DESIGN.EXTERNAL_SUPPORTIVE_PATIENTS] patients, respectively.
...
<!-- BEGIN_ARTIFACT_BOUND_RESULTS -->
U-Net+RES has [PENDING:RESOURCE.UNET_RES.PARAMETER_COUNT] parameters,
